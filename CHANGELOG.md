...
2. **macOS windows start their display link when they're shown and skip tab-group queries while they're the only window open.** Launch to second frame dropped by about 18 ms (171.5 ms to 153.9 ms, median of 10 interleaved runs). [#599](https://github.com/Ernxst/gpuix/issues/599), [PR #690](https://github.com/Ernxst/gpuix/pull/690), [Ernxst/zed#3](https://github.com/Ernxst/zed/pull/3)
